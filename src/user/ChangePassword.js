    ...
    <div>
        ...
        <div className='form'>
            <div className='form-item'>
                <Form.Control className='auth-form' name='password' placeholder='Current Password' onChange={changeHandler}></Form.Control>
            </div>
            <div className='form-item'>
        ...
        <Button className='button' variant='priamry' onClick={loginHandler}>Update Password</Button>
